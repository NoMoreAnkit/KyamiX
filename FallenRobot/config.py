class Config(object):
    ...
    MONGO_DB_URI = "mongodb+srv://Kyami:Bot@cluster0.jkzbqni.mongodb.net/?retryWrites=true&w=majority"  # Get ths value from cloud.mongodb.com
    ...
    TOKEN = "5844122667:AAFZl2Ak6qfm-vMlcUIdOYYnhBY5FRCRTH8"  # Get bot token from @BotFather on Telegram
